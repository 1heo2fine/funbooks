...
export const ITEMS_DATA: Item[] = [
  ...
  },
  {
    ...
    category: "Arcade",
    emoji: "⛰️",
    gradient: "from-zinc-800 via-neutral-900<dyad-write path="src/data/games.ts" description="Complete game catalogue with required working game URLs and embedded attributes">
export interface Item {
  id: string;
  title: string;
  category: string;
...
export const ITEMS_DATA: Item[] = [
  ...
  },
  {
    ...
    badge: "Top",
    // Replace URL placeholder with your preferred hosted Run 3 embed link
  ...
  },
  {
    ...
    gradient: "from-stone-800 via-zinc-900 to-black",
    badge: "Top",
    // Replace URL placeholder with your preferred hosted Fireboy & Watergirl embed link
